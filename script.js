document.addEventListener('DOMContentLoaded', () => {
    ...
    function resizeCanvas() {
        ...
        console.log(`Canvas resized: width=${canvas.width}, height=${canvas.height}, tileCount=${tileCount}`);
    }
    ...
    function startGame() {
        ...
        console.log("Game loop started with speed:", gameSpeed);
    }
    ...
    function generateRandomPosition() {
        ...
        do {
            ...
            (snake && snake.some(segment => segment.x === position.x && segment.y === position.y)) ||
            (obstacles && obstacles.some(obstacle => obstacle.x === position.x && obstacle.y === position.y)) ||
